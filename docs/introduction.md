...
lttle.cloud is fully compliant with the [Open Container Initiative](https://opencontainers.org/) standards. This means you can package your code in any OCI-compliant image (Docker, Podman, ...), ship it to us and it will run it seamlessly.

:::note Question

Are we really OCI-compliant now?
...
We should add a benchmark here similar to [this one](https://maxday.github.io/lambda-perf/).
