...
sidebar_position: 4
---
import CommonResourceNameValidation from '../parts/_resource-name-validation.md'
...
If you want to use `https` or `tls` with your custom domain, you also need to create a [certificate resource](./certificates.mdx) with the same domain. This resource will configure TLS termination with a valid certificate matching your domain.
