...
const FeatureList1: FeatureItem[] = [
    {
        ...
        description: (
            <>
                lttle.cloud is designed to be lightweight and efficient, with a
    ...
    },
    {
        ...
        description: (
            <>
                lttle.cloud is designed to be simple and easy to use, with a
...
const FeatureList2: FeatureItem[] = [
    {
        ...
        description: (
            <>
                lttle.cloud is designed to be secure and reliable, with a focus
